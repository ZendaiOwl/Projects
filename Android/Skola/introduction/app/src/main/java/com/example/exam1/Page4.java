...
import com.example.exam1.databinding.ActivityPage4Binding;
...
public class Page4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.binding = ActivityPage4Binding.inflate(getLayoutInflater());
        setContentView(this.binding.getRoot());
        initVAR();
        try {
            openPDF(imgView,this.pageNr4);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private void initVAR() {
        TAG = getString(R.string.TAG_Page4);
        this.imgView = this.binding.imgViewPage4Pdf;
        this.pageNr4 = 3;
    }
    /**
