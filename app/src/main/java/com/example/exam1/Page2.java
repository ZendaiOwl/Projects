...
import com.example.exam1.databinding.ActivityPage2Binding;
...
public class Page2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.binding = ActivityPage2Binding.inflate(getLayoutInflater());
        setContentView(this.binding.getRoot());
        initVAR();
        try {
            openPDF(imgView,this.pageNr2);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private void initVAR() {
        TAG = getString(R.string.TAG_Page2);
        this.imgView = this.binding.imgViewPage2Pdf;
        this.pageNr2 = 1;
    }
