...
namespace OCA\Translate\Tests\Integration\Controller;

use OCP\AppFramework\App;
use OCP\IRequest;
use PHPUnit\Framework\TestCase;

use OCA\Translate\Db\Note;
use OCA\Translate\Db\NoteMapper;
use OCA\Translate\Controller\NoteController;
