...
import com.example.exam1.databinding.ActivityPage1Binding;
import java.io.File;
...
public class Page1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.binding = ActivityPage1Binding.inflate(getLayoutInflater());
        setContentView(this.binding.getRoot());
        initVAR();
        try {
            openPDF(imgView,this.pageNr1);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private void initVAR() {
        TAG = getString(R.string.TAG_Page1);
        this.imgView = this.binding.imgViewPage1Pdf;
        this.pageNr1 = 0;
    }
